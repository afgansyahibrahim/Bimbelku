...
return new class extends Migration
{
    ...
    {
        // Data Perguruan Tinggi tidak dipulihkan karena jenjang tersebut telah
        // dikeluarkan dari cakupan layanan. Riwayat transaksi tetap disimpan.
    }
    ...
    private function removeLevelFromJsonColumn(
        ...
        if (
            !Schema::hasTable($table)
            || !Schema::hasColumn($table, $levelsColumn)
        ) {
            return;
        }
