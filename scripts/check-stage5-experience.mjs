...
expect(studentController.includes("Rule::in([1, 2, 3])") && studentController.includes("addHours($durationHours)"), "setiap sesi paket wajib memakai durasi 1, 2, atau 3 jam");
