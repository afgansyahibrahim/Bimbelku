                ...
                <div className="relative">
                    ...
                    <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-2xl relative z-10 overflow-hidden group hover:border-white/20 transition-all duration-500">
                      ...
                      <Link to="/register?role=student">
                        <Button size="lg" className="w-full h-14 text-base rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold shadow-lg shadow-blue-600/30 border-0 transition-all hover:scale-[1.02] active:scale-[0.98]">
