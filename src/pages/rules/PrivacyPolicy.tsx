...
const sections = [
  ...
  },
  {
    ...
    text: "Koordinat dan alamat hanya diwajibkan saat pengguna memilih sesi offline. Data ini digunakan untuk menghitung radius 3, 5, 8, hingga 12 km. Kandidat tutor hanya melihat perkiraan jarak; alamat lengkap diberikan setelah pembayaran diverifikasi dan sesi dikonfirmasi. Pada kelompok offline, lokasi pembuat kelompok menjadi lokasi sesi.",
  },
  {
    title: "Bukti pembayaran dan pelaksanaan",
    text: "Bukti transfer, nama pengirim, bank, foto pelaksanaan, laporan ketidakhadiran, bukti keadaan darurat, bukti refund, dan bukti pencairan disimpan untuk verifikasi serta penyelesaian sengketa. Jangan mengunggah informasi yang tidak diperlukan. Dokumen kesehatan boleh menyembunyikan diagnosis dan informasi medis pribadi selama identitas, waktu, dan terjadinya keadaan tetap dapat diperiksa.",
  },
  {
    title: "Tujuan penggunaan",
    text: "Data digunakan untuk autentikasi, verifikasi tutor, pencocokan materi dan jadwal, perhitungan jarak, pemrosesan pembayaran manual, komisi, refund, pencairan, pencegahan bentrok, penanganan laporan, keamanan akun, dukungan pengguna, dan pemenuhan kewajiban hukum.",
  },
  {
